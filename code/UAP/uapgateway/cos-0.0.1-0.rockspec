...
source = {
  url = "git+https://github.com/apig/apig.git",
  tag = "1.0.0"
}
description = {
  summary = "APIG is a scalable and customizable API Management Layer built on top of Nginx.",
...
build = {
  ...
  modules = {
    ...
    ["cos.tools.redis.redis"] = "kong/tools/redis/redis.lua",
    ["cos.tools.redis.zredis"] = "kong/tools/redis/zredis.lua",
  }
}
